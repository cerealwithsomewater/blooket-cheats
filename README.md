<p align="center">Cheats made by 0n3</p>
...
1. Importing one of the Bookmarklets.html files using [these instructions](https://github.com/0n3/Blooket-Cheats/blob/main/tutorial/readme.md)
<!-- 2. Going to the [GitHub pages site](https://0n3.github.io/Blooket-Cheats), choosing a gamemode, then dragging a cheat to your bookmarks bar or clicking one to copy the script -->
...
Make sure you're running it properly, if it still doesn't work and other cheats do, then [make an issue](https://github.com/0n3/Blooket-Cheats/issues)
</details>
...
Minesraft2 was sent a cease and desist from Blooket, and 0n3 took over the project.
</details>
