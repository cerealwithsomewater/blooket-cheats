...
(() => {
    ...
    const cheat = (async () => {
        ...
        creditLinks.append(createCredit("GitHub", '<a target="_blank" href="https://github.com/0n3/Blooket-Cheats">0n3/Blooket-Cheats</a>'));
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/0n3/Blooket-Cheats/main/autoupdate/timestamps/KGui.png?" + Date.now();
